...
//    }
    ...
    String pop2() {
        if(getContext().getValueStack().size() != 0) {
            return (String)pop();
        }
        return "";
    }
...
//    }
    ...
    // * subAttr   = "." ATTRNAME
    Rule subAttr(Var<SubAttr> subAttribute) {
        return Sequence(".", attrName(), subAttribute.set(new SubAttr(pop())));
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            ParsingResult<?> result = new ReportingParseRunner(parser.attrName()).run(input);
